					...
					<div class="space-y-2">
						...
						<Breadcrumb>
							<BreadcrumbList variant="solid">
								...
								<BreadcrumbItem>
									<BreadcrumbPage
										>Getting Started</BreadcrumbPage
									>
								</BreadcrumbItem>
							</BreadcrumbList>
						</Breadcrumb>
				...
				<div class="space-y-6">
					...
					<div class="space-y-2">
						...
						<Breadcrumb>
							<BreadcrumbList>
								<BreadcrumbItem>
									<BreadcrumbLink variant="underline" href="/"
										>Home</BreadcrumbLink
									>
								</BreadcrumbItem>
								<BreadcrumbSeparator />
					...
					<div class="space-y-2">
						...
						<Breadcrumb>
							<BreadcrumbList>
								<BreadcrumbItem>
									<BreadcrumbLink variant="subtle" href="/"
										>Home</BreadcrumbLink
									>
								</BreadcrumbItem>
								<BreadcrumbSeparator />
					...
					<div class="space-y-2">
						...
						<Breadcrumb>
							<BreadcrumbList>
								...
								<BreadcrumbItem>
									<BreadcrumbLink href="/custom"
										>Custom</BreadcrumbLink
									>
								</BreadcrumbItem>
								<BreadcrumbSeparator>
									<span class="text-muted-foreground">→</span>
					...
					<div class="space-y-2">
						...
						<Breadcrumb>
							<BreadcrumbList>
								...
								<BreadcrumbSeparator />
								<BreadcrumbItem>
									<BreadcrumbPage variant="default"
							...
							<BreadcrumbItem>
								{#if segment.href}
									<BreadcrumbLink href={segment.href}
										>{segment.label}</BreadcrumbLink
									>
								{:else}
									<BreadcrumbPage
										>{segment.label}</BreadcrumbPage
									>
								{/if}
							</BreadcrumbItem>
