<script lang="ts">
	...
	import {
		...
		cardVariantsDocs,
		paddingOptionsDocs,
		interactiveStatesDocs,
		headerActionsDocs,
		footerContentDocs,
		complexExamplesDocs,
		variantCombinationsDocs
	} from "$lib/code-blocks/card";
...
<div class="container mx-auto p-6 max-w-6xl">
	<div class="mb-8">
		<h1 class="text-3xl font-bold mb-2">Card Component</h1>
