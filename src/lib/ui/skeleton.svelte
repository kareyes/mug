<script lang="ts">
	...
	let selectedAnimation = $state<"pulse" | "shimmer" | "wave" | "none">(
		"pulse",
	);
					...
					<div class="flex items-center gap-2">
						...
						<div class="flex gap-1">
							{#each ["pulse", "shimmer", "wave", "none"] as anim}
								<Button
									variant={selectedAnimation === anim
										? "default"
										: "outline"}
									size="sm"
									onclick={() =>
										(selectedAnimation =
											anim as typeof selectedAnimation)}
								>
									{anim}
								</Button>
							{/each}
			...
			<PreviewContainer>
				<div class="grid gap-6 @md:grid-cols-2">
					<div class="space-y-4 rounded-lg border p-4">
						...
						{:else}
							<p class="text-sm">
								This is the actual content that would be
								displayed after loading. It contains multiple
								lines of text to demonstrate the skeleton
								placeholder.
							</p>
						{/if}
					</div>
					...
					<div class="space-y-4 rounded-lg border p-4">
						...
						{:else}
							<div class="flex items-center gap-3">
								<div
									class="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-sm text-primary-foreground"
								>
									JD
								</div>
								<div>
						...
						{:else}
							...
							>
								<img
									...
									alt="Card"
									class="mb-4 -mx-4 -mt-4 rounded-t-lg"
								/>
					...
					<div class="space-y-4 rounded-lg border p-4">
						...
						{:else}
							<div class="space-y-4">
								...
								<p class="text-sm">
									Just finished building this awesome skeleton
									component! 🎉
								</p>
								<div
						...
						{:else}
							<div class="space-y-3">
								{#each ["Widget Pro", "Gadget Plus", "Device Ultra"] as product}
									<div class="flex gap-4">
										<div
											class="h-16 w-16 shrink-0 rounded-lg bg-muted"
										></div>
										<div class="flex-1">
