	...
	<div class="space-y-12">
		...
		<Card variant="ghost" class="space-y-3 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Bordered variant combined with different color options creates a
		...
		<Card variant="ghost" class="space-y-3 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Bordered avatars work great with images too, showing a subtle
				colored ring.
			</p>
			<PreviewContainer>
				<div class="flex flex-wrap gap-4">
		...
		<Card variant="ghost" class="space-y-3 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Display online, offline, away, and busy status with colored
				indicators.
			</p>
			<PreviewContainer>
				<div class="flex flex-wrap gap-6">
		...
		<Card variant="ghost" class="space-y-3 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Show notification badges with optional counts. Displays "99+"
				for counts over 99.
			</p>
			<PreviewContainer>
				<div class="flex flex-wrap gap-6">
		...
		<Card variant="ghost" class="space-y-3 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Combine status indicators, notifications, borders, and colors
				for rich user presence display.
			</p>
			<PreviewContainer>
				<div class="flex flex-wrap gap-6">
					<div class="text-center">
						...
						>
							<Avatar
								...
								status={["online", "busy", "away", "offline"][
									i
								] as "online" | "busy" | "away" | "offline"}
								showNotification={i % 2 === 0}
								notificationCount={i % 2 === 0
									? (i + 1) * 3
									: undefined}
							/>
							<div>
