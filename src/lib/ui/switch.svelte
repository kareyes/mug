<script lang="ts">
	...
	const variants: SwitchPrimitives.SwitchVariant[] = [
		"default",
		"success",
		"warning",
		"danger",
...
<div class="container mx-auto p-6 max-w-6xl">
	...
	<div class="space-y-12">
						...
						<div class="flex items-center space-x-2">
							<Switch
								...
								onCheckedChange={(checked) =>
									handleSwitchChange("basic", checked)}
							/>
						...
						<div class="space-y-2">
							...
							<div class="flex items-center space-x-2">
								<Switch
									...
									bind:checked={
										states.variants[
											variant as keyof typeof states.variants
										]
									}
									onCheckedChange={(checked) =>
										handleSwitchChange(
						...
						<div class="space-y-2">
							...
							<div class="flex items-center space-x-2">
								<Switch
									...
									bind:checked={
										states.sizes[
											size as keyof typeof states.sizes
										]
									}
									onCheckedChange={(checked) =>
										handleSwitchChange(
		...
		<Card variant="ghost" class="p-6 bg-background">
			...
			<PreviewContainer>
				<div
					class="max-w-md space-y-4 p-6 border border-border rounded-lg"
				>
				...
				<div class="space-y-4 mt-6">
					...
					<FieldPrimitives.Set>
						<FieldPrimitives.Legend
							>Notification Preferences</FieldPrimitives.Legend
						>
						<FieldPrimitives.Description
							>Configure how you want to be notified</FieldPrimitives.Description
						>
			...
			<PreviewContainer>
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
					<div class="space-y-2">
						...
						<pre
							class="text-sm bg-muted p-4 rounded-md overflow-auto">{JSON.stringify(
								{
