					...
					<Button
						...
						onclick={() =>
							toast.success("File uploaded", {
								description:
									"Your document has been saved to the cloud successfully.",
							})}
					>
					...
					<Button
						...
						onclick={() =>
							toast.warning("Low storage", {
								description:
									"You are using 95% of your available storage. Consider upgrading.",
							})}
					>
					...
					<Button
						...
						onclick={() =>
							toast.info("New version available", {
								description:
									"Version 2.0.0 introduces exciting new features and improvements.",
							})}
					>
					...
					<Button
						...
						onclick={() =>
							toast.success("Event created", {
								description:
									"Your event has been scheduled for tomorrow at 3 PM.",
								action: {
									label: "View Event",
									onClick: () =>
					...
					<Button
						onclick={() => {
							toast.promise(simulateAsyncOperation(true), {
								...
								success: (data) =>
									`${(data as { items: number; name: string }).name} uploaded successfully!`,
					...
					<Button
						...
						onclick={() => {
							...
							toast.promise(promise, {
								...
								success: (data) =>
									`Processed ${(data as { count: number }).count} items`,
								error: (err) =>
			...
			<PreviewContainer>
				<div class="flex flex-wrap gap-3">
					<Button
						variant="outline"
						onclick={() =>
							toast.info("Quick toast", { duration: 1000 })}
					>
						1 Second
					</Button>
					<Button
						variant="outline"
						onclick={() =>
							toast.info("Normal toast", { duration: 4000 })}
					>
						4 Seconds
					</Button>
					<Button
					...
					<Button
						color="warning"
						onclick={() =>
							toast.warning("Persistent notification", {
								description:
					...
					<Button
						...
						onclick={() =>
							toast.success("Custom styled toast", {
								description:
									"This toast has custom border styling.",
				...
				<div class="flex flex-wrap gap-3">
					<Button
						onclick={async () => {
							...
							await new Promise((r) => setTimeout(r, 1500));
							toast.loading("Step 3: Saving to database...", {
								id,
							});
