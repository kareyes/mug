<script lang="ts">
  ...
  const planOptions: RadioGroupOption[] = [
    ...
    },
    {
      ...
      label: "Enterprise",
      value: "enterprise",
      description: "$99/month - Full features",
    },
  ];
    ...
    <Card variant="ghost" class="p-6 bg-background">
      ...
      <PreviewContainer>
        ...
        <div class="space-y-2 mt-4">
          ...
          <p class="text-sm text-muted-foreground">
            Notification: <Badge variant="outline"
              >{notificationPreference}</Badge
            >
          </p>
        </div>
      </PreviewContainer>
            ...
            options={[
              {
                ...
                label: "Soft Delete",
                value: "soft",
                description: "Move items to trash (recoverable)",
              },
              {
                id: "perm-del",
                label: "Permanent Delete",
                value: "permanent",
                description: "Delete permanently (cannot be undone)",
              },
            ]}
            value="soft"
            label="Warning Variant"
