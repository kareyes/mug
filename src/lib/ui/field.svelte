...
<div class="container mx-auto p-6 max-w-6xl">
    ...
    <div class="space-y-12">
                ...
                >
                    <FieldPrimitives.Set>
                        <FieldPrimitives.Legend
                            >Account Information</FieldPrimitives.Legend
                        >
                        <FieldPrimitives.Description>
                            Create your account by filling out the information
                            below.
                        </FieldPrimitives.Description>
                    ...
                    <FieldPrimitives.Set>
                        <FieldPrimitives.Legend
                            >Preferences</FieldPrimitives.Legend
                        >
                    ...
                    <FieldPrimitives.Set>
                        <FieldPrimitives.Legend
                            >Subscription Plan</FieldPrimitives.Legend
                        >
                        <FieldPrimitives.Description
            ...
            <PreviewContainer>
                <div class="space-y-8">
                    ...
                    <Card class="bg-muted/50">
                        <FieldPrimitives.Set>
                            <FieldPrimitives.Legend
                                >Account Setup</FieldPrimitives.Legend
                            >
                            <FieldPrimitives.Description
        ...
        <Card variant="ghost" class="p-6 bg-background">
            <h2 class="text-2xl font-semibold mb-4">
                RadioGroup with Field Component
            </h2>
            <p class="text-sm text-muted-foreground mb-4">
            ...
            <PreviewContainer>
                <div class="space-y-8">
                    ...
                    <Card class="bg-muted/50">
                        <FieldPrimitives.Set>
                            <FieldPrimitives.Legend
                                >Product Configuration</FieldPrimitives.Legend
                            >
                            <FieldPrimitives.Description
        ...
        <Card variant="ghost" class="p-6 bg-background">
            <h2 class="text-2xl font-semibold mb-4">
                Input OTP with Field Component
            </h2>
            <p class="text-sm text-muted-foreground mb-4">
        ...
        <Card variant="ghost" class="p-6 bg-background">
            <h2 class="text-2xl font-semibold mb-4">
                File Input with Field Component
            </h2>
            <p class="text-sm text-muted-foreground mb-4">
        ...
        <Card variant="ghost" class="p-6 bg-background">
            <h2 class="text-2xl font-semibold mb-4">
                Date Picker with Field Component
            </h2>
            <p class="text-sm text-muted-foreground mb-4">
                    ...
                    <Card>
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Control appears before label (common pattern
                                    for checkboxes)
                                </p>
                            </div>
        ...
        <Card variant="ghost" class="p-6 bg-background">
            ...
            <PreviewContainer>
                <Card class="bg-muted/50">
                    <FieldPrimitives.Set>
                        <FieldPrimitives.Legend
                            >Place Your Order</FieldPrimitives.Legend
                        >
                        <FieldPrimitives.Description>
                            Fill out the order form with all the necessary
                            details
                        </FieldPrimitives.Description>
                        <FieldPrimitives.Separator />
