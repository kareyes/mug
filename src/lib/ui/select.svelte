          ...
          <div>
            ...
            <Select
              ...
              onSelectionChange={(value: any) =>
                handleSelectionChange("basic", value)}
            />
            {#if basicValue}
        ...
        <div class="space-y-4">
          <div>
            <span class="block text-sm font-medium mb-2"
              >Choose multiple frameworks:</span
            >
            <Select
              ...
              class="w-[250px]"
              onSelectionChange={(value: any) =>
                handleSelectionChange("multiple", value)}
            />
        ...
        <div class="space-y-4">
          <div>
            ...
            <Select
              ...
              class="w-[250px]"
              onSelectionChange={(value: any) =>
                handleSelectionChange("grouped", value)}
            />
            {#if groupedValue}
              <p class="text-sm text-muted-foreground mt-2">
    ...
    <Card variant="ghost" class="p-6 bg-background">
      ...
      <PreviewContainer>
        <div class="grid grid-cols-1 @md:grid-cols-2 gap-6">
          ...
          <div>
            <span class="block text-sm font-medium mb-2 text-muted-foreground"
              >Disabled</span
            >
            <Select
              options={fruits}
