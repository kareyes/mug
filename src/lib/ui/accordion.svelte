<script lang="ts">
    import { allVariantsDocs, borderedDocs, defaultDocs, defaultExpandedDocs, disabledDocs, FAQDocs, multipleDocs, shadowDocs, splittedDocs } from "$lib/code-blocks/accordion";
	import {
			...
			<Accordion.Root type="single" variant="bordered" class="w-full">
				...
				<Accordion.Item value="item-3">
					...
					<Accordion.Content>
						...
						subscriptions. If you're not satisfied, contact our
			...
			<Accordion.Root type="single" variant="splitted" class="w-full">
				<Accordion.Item value="item-1">
					...
					<Accordion.Content>
						...
						in your email, create a password, and you're ready to
						go!
					</Accordion.Content>
				</Accordion.Item>
				<Accordion.Item value="item-2">
					...
					>
					<Accordion.Content>
						Click "Forgot Password" on the login page. Enter your
				...
				<Accordion.Item value="item-3">
					...
					<Accordion.Content>
						...
						settings. Note that this can only be done once every 30
						days.
					</Accordion.Content>
				</Accordion.Item>
			</Accordion.Root>
			...
			<Accordion.Root type="single" variant="shadow" class="w-full">
				<Accordion.Item value="item-1">
					...
					<Accordion.Content>
						...
						active. Upon account deletion, your data is permanently
				...
				<Accordion.Item value="item-2">
					...
					>
					<Accordion.Content>
						We use industry-standard encryption (AES-256) for data
						at rest and TLS 1.3 for data in transit. Our systems are
						regularly audited.
					</Accordion.Content>
				</Accordion.Item>
				<Accordion.Item value="item-3">
					...
					<Accordion.Content>
						...
						account settings. We provide exports in JSON and CSV
						formats.
					</Accordion.Content>
				</Accordion.Item>
			</Accordion.Root>
			...
			<div class="max-w-2xl">
				<Accordion.Root type="single" variant="splitted" class="w-full">
					<Accordion.Item value="shipping">
						...
						<Accordion.Content>
							...
							>
								...
								<li>
									<strong>Overnight Shipping:</strong> Next business
									day - $24.99
								</li>
							</ul>
						</Accordion.Content>
					...
					<Accordion.Item value="returns">
						...
						>
						<Accordion.Content>
							We offer a hassle-free 30-day return policy. Items
							must be unused and in their original packaging. Once
							we receive your return, refunds are processed within
							5-7 business days.
						</Accordion.Content>
					</Accordion.Item>
					<Accordion.Item value="warranty">
						...
						<Accordion.Content>
							...
							are available at checkout for an additional 2 years
							of coverage.
						</Accordion.Content>
					</Accordion.Item>
					<Accordion.Item value="international">
						...
						<Accordion.Content>
							...
							International shipping rates and delivery times vary
							by location. You can see the available options at
							checkout.
						</Accordion.Content>
					</Accordion.Item>
				</Accordion.Root>
