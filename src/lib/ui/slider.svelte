<script lang="ts">
	...
	import {
		...
		verticalOrientationDocs,
		withFieldDocs,
		disabledStateDocs,
	} from "../code-blocks/slider";
	...
	// Marks definitions
	const volumeMarks: SliderPrimitives.SliderMark[] = [
		{ value: 0, label: "🔇" },
		{ value: 50, label: "🔉" },
		{ value: 100, label: "🔊" },
	];
...
<div class="container mx-auto p-6 max-w-6xl">
	<!-- <div class="mb-8">
		<h1 class="text-3xl font-bold mb-2">Slider Demo</h1>
	...
	<div class="space-y-12">
		...
		<Card variant="outline" class="p-6">
			...
			<div class="max-w-2xl space-y-6 mb-4">
				...
				<Field label="Temperature" description="Set the desired temperature (16-30°C)">
					<Slider
						type="single"
						value={22}
						min={16}
				...
				<Field label="Price Range" description="Filter products by price ($0-$1000)">
					<Slider
						type="multiple"
						value={[100, 500]}
						min={0}
				...
				<Field label="Rating" description="Select your rating (1-5 stars)">
					<Slider
						type="single"
						value={3}
						min={1}
