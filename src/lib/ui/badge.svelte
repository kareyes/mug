<script lang="ts">
	import {
		basicVariantsDocs,
		colorVariantsDocs,
		variantColorComboDocs,
		sizesDocs,
		shapesDocs,
		shapeVariantComboDocs,
		withIconsDocs,
		loadingStateDocs,
		clickableBadgesDocs,
		dismissableBadgesDocs,
		notificationBadgesDocs,
		statusIndicatorsDocs,
		userProfileDocs,
		productCardsDocs,
...
<div class="container mx-auto p-6 max-w-6xl">
	...
	<div class="space-y-12">
		...
		<Card variant="ghost" class="p-6 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				All variants can be combined with any color using
				compoundVariants
			</p>
			<PreviewContainer>
				<div class="space-y-4">
		...
		<Card variant="ghost" class="p-6 bg-background">
			...
			<p class="text-sm text-muted-foreground mb-4">
				Three shape options: rounded (default), circle (pill), and
				square
			</p>
			<PreviewContainer>
				<div class="space-y-4">
				...
				<div class="space-y-3">
					<div class="flex flex-wrap gap-2">
						<Badge
							...
							clickable={true}
							onclick={() =>
								handleBadgeClick("Default clickable")}
						/>
						<Badge
							text="Secondary"
							variant="secondary"
			...
			<PreviewContainer>
				<div class="space-y-2">
					{#each notifications as notification (notification.id)}
						...
						>
							<span class="text-sm"
								>You have a new notification</span
							>
							<Badge
